...
def CEX_GEN(json_data):
    ...
    while (True):
        ...
        diag = Bounded_DFS(model, min_max_dict, diag, target_var, target_index, target_value, K)
        print('K = ' + str(K))
...
def Bounded_DFS(model, min_max_dict, diag, target_var, target_index, target_value, K):
    # r_count = {}
