...
class test: 
	def __init__(self): 
		...
		self.reactions = [None] * len(R)
		for i, e in enumerate(R):
			R_effect = np.array(np.array(e[1])-np.array(e[0])).tolist()
			self.reactions[i] = [e[0], e[1], R_effect] 
	
	def get_species_tuple(self):
		return  self.species_tuple_
...
class enzymatic_futile_cycle: 
	def __init__(self): 
		...
		###########################################################
		####### change this block for adding a new model ##########
		self.species_tuple_ = ('S1', 'S2', 'S3', 'S4', 'S5', 'S6')
...
class yeast_polarization: 
	def __init__(self): 
		...
		###########################################################
		####### change this block for adding a new model ##########
		self.species_tuple_ = ('R', 'L', 'RL', 'G', 'Ga', 'Gbg', 'Gd')
...
class motility_regulation: 
	def __init__(self): 
		...
		###########################################################
		####### change this block for adding a new model ##########
		self.species_tuple_ = ('codY', 'flache', 'SigD_hag', 'hag', 'CodY_flache', 'CodY_hag', 'CodY', 'SigD', 'Hag')
