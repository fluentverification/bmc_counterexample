...
Enzymatic Futile Cycle is a chemical reaction network consisting of 6 chemical species reacting through 6 reaction channels. This model is defined by the following set of reactions:
...
Motility regulation is a chemical reaction network of a gene regulatory network consisting of 9 chemical species reacting through 12 reaction channels. This model is defined by the following set of reactions:
...
Yeast Polarization is a chemical reaction network model consisting of 7 chemical species reacting through 8 reaction channels. This model is defined by the following set of reactions:
