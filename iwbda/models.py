...
class circuit0x8E_010_111: 
	...
	def reaction_rates(self, var_values): 
		X = var_values
		...
		#each Ri_in and Ri_out is the same size as species_vector
		# R1  = PhlF_degradation_interaction
		# R2  = YFP_degradation_interaction
		# R3  = HlyIIR_degradation_interaction
		# R4  = BetI_degradation_interaction
		# R5  = AmtR_degradation_interaction
		# R6  = topModel_AmtRpart_module_sub__AmtR_protein_interaction_0
		# R7  = topModel_AmtRpart_module_sub__AmtR_protein_interaction_1
		# R8  = topModel_YFPpart_module_sub__YFP_protein_interaction_0
		# R9  = topModel_YFPpart_module_sub__YFP_protein_interaction_1
		# R10 = topModel_BetIpart_module_sub__BetI_protein_interaction_0
		# R11 = topModel_BetIpart_module_sub__BetI_protein_interaction_1
		# R12 = topModel_PhlFpart_module_sub__PhlF_protein_interaction_0
		# R13 = topModel_PhlFpart_module_sub__PhlF_protein_interaction_1
		# R14 = topModel_HlyIIRpart_module_sub__HlyIIR_protein_interaction_0
		# R15 = topModel_HlyIIRpart_module_sub__HlyIIR_protein_interaction_1
		...
		# R1_r  = 1.0 # PhlF_degradation_interaction
		# R2_r  = 1.0 # YFP_degradation_interaction
		# R3_r  = 1.0 # HlyIIR_degradation_interaction
		# R4_r  = 1.0 # BetI_degradation_interaction
		# R5_r  = 1.0 # AmtR_degradation_interaction
		# R6_r  = 1.0 # PhlF_degradation_interaction
		# R7_r  = 1.0 # YFP_degradation_interaction
		# R8_r  = 1.0 # HlyIIR_degradation_interaction
		# R9_r  = 1.0 # BetI_degradation_interaction
		# R10_r = 1.0 # AmtR_degradation_interaction
		# R11_r = 1.0 # PhlF_degradation_interaction
		# R12_r = 1.0 # YFP_degradation_interaction
		# R13_r = 1.0 # HlyIIR_degradation_interaction
		# R14_r = 1.0 # BetI_degradation_interaction
		# R15_r = 1.0 # AmtR_degradation_interaction
		

		#                       R1    R2    R3    R4    R5    R6    R7    R8    R9    R10    R11    R12    R13    R14    R15
		self.reaction_rates_ = [R1_r, R2_r, R3_r, R4_r, R5_r, R6_r, R7_r, R8_r, R9_r, R10_r, R11_r, R12_r, R13_r, R14_r, R15_r]
		return self.reaction_rates_